<template>
    ...
    <img src="../../images/shortly.png" alt="">
      </div>
        <div class="h-full w-full px-4 md:w-[30%] border-2 border-l-0 border-r-0 py-5 md:px-4 border-colorTertiary">
          <h4 class="text-colorText font-bold text-xl md:text-3xl border-b border-colorTertiary pb-5">Shortly</h4>
          ...
          <a href="https://shortly-eleazer.netlify.app/" class="hover:text-colorSecondary text-colorText text-sm md:text-xl">https://shortly-eleazer.netlify.app/</a>
