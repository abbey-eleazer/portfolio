...
<template>
  <div class="flex items-center justify-evenly mx-auto mt-12 w-[100%] md:w-[80%] md:mt-32 md:pb-24 flex-col">
 
   <div class=" w-[80%] rounded-md pb-10 md:w-[40%] md:rounded-xl object-contain overflow-hidden transform rotate-6">
 <img src="../../images/Fylo.png" alt="">
   </div>
     <div class="h-full w-full px-4 md:w-[30%] border-2 border-l-0 border-r-0 py-5 md:px-4 border-colorTertiary">
       <h4 class="text-colorText font-bold text-xl md:text-3xl border-b border-colorTertiary pb-5">Fylo</h4>
       ...
       <a href="https://fylo-eleazer.netlify.app" class="hover:text-colorSecondary text-colorText text-sm md:text-xl">https://fylo-eleazer.netlify.app</a>
